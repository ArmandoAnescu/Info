...
<div class="container mt-5 mb-5">
    <h1 class="mt-3 pt-3">Campionato Formula 1</h1>
    <br>
    <h2>Benvenuti</h2>
    <p  class="lead">Qui potete trovare le classifiche delle gae di formula uno, da quella attuale a quelle passate.
        Potete trovare le classifiche dei piloti,delle case automobilisitche e i vari risultati di ogni gara.
        Potrete aggiungere e modificare i risultati pe rcorregerli.
    </p>
    <h2>Perchè?</h2>
    <p>
